...
# changed infection parameter from 2.316 to 4
# changed recovery parameter from 0.261 to 0.05
parameters <- c(beta = 4, gamma = 0.05)

## Time frame
# changed time frame to 25 from 100
